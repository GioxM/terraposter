...
------------------------------------------------------------------------------
python main.py -c "Amsterdam" -C "Netherlands" -t noir-neon-teal -d 1500 --dpi 600 -v

# Should say "Using DPI: 600 for PNG"

python main.py -c "Amsterdam" -C "Netherlands" -t noir-neon-teal -d 1500 --quality screen

# Should use 150 dpi

python main.py -c "Amsterdam" -C "Netherlands" -t noir-neon-teal -d 1500 --quality high --format svg

# Should warn that DPI is ignored for SVG
